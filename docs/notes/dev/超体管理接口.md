...
| cdkey_id    | 余额卡ID                    |
| enable      | 是否启用超体                   |
| model_id    | 模型ID；0：林晓晓（默认）<br> ，1：艾米 |
| cdkey_name  | 余额卡兑换码                   |
| api_limit   | 剩余调度额度                   |
| cdkey_type  | 余额卡类型                    |
| server_ip   | 节点IP                     |
...
| 字段名      | 类型     | 必填 | 描述                       |
|----------|--------|----|--------------------------|
| cdkey_id | string | 是  | 余额卡ID                    |
| name     | string | 是  | 超体名称                     |
| type     | string | 是  | 超体类型；0：AI对话（默认填0）        |
| enable   | string | 否  | 是否启用；0：不启用 ，1：启用         |
| model_id | string | 否  | 模型ID；0：林晓晓（默认）<br> ，1：艾米 |
...
| data    | array   | 是  | 返回的超体数据，参考 [`超体信息`](#jump) |
...
```json
{
  ...
  "config": {
    ...
    "iat_config": {
      "api_key": "af180a31deae4f76b84bdc3d39ba8e17",
...
```json
{
  ...
  "data": {
    ...
    "enable": "1",
    "model_id": "001",
    "config": "{\"iat_server\":\"esp-ai-asr-volcengine\",\"iat_config\":{\"api_key\":\"af180a31deae4f76b84bdc3d39ba8e17\",\"clusterId\":\"volcengine_streaming_common\"},\"tts_server\":\"esp-ai-tts-volcengine\",\"tts_config\":{\"api_key\":\"af180a31deae4f76b84bdc3d39ba8e17\",\"voice_type\":\"zh_female_wanwanxiaohe_moon_bigtts\"},\"llm_server\":\"esp-ai-llm-volcengine\",\"llm_config\":{\"api_key\":\"af180a31deae4f76b84bdc3d39ba8e17\",\"epId\":\"ep-20250215214941-l969g\"},\"llm_init_messages\":[{\"content\":\"你是小明同学，你要书本中小明同学的语气和用户聊天。\",\"id\":\"214562\",\"role\":\"system\"}],\"connected_reply\":\"服务连接成功。\"}",
    "sort": "1",
